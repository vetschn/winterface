      ...
      printHelpTuple_(
          ...
          std::make_tuple(
              ...
              HELP__("bzbounds", p.bzbounds,
                     "bounds to use when generating the mesh, in reciprocal "
                     "basis"),
              HELP__("rho_k", p.rho_k,
                     "density of kpoints points in the Brillouin Zone of the "
                     "NN only orthorhmobic cell\n"
                     "a meshgrid approximately matching this density is used, "
                     "in units A^-dim\n"
                     "setting this to .0 will turn off bandstructure check"),
              HELP__("maj_style", p.maj_style,
                     "setting this to MATLAB for a mesh like that from the "
                     "meshgrid function\n"
                     " - inorder: 0,1,2,...\n"
                     " - MATLAB: 1,0,2,...")
              ...
              HELP__("Nk", p.Nk,
                     "number of points along the additional ktrace "
              ...
              HELP__("hrdat", p.hrdat,
                     "wannier90 hamiltonian data file to use for folding "
                     "alorithms"),
              HELP__("re", p.re,
                     "switch to use the real part only of the wannier90 "
                     "hamiltonian data\n"
                     "durch bandstructure calculations"),
              HELP__("Lvb", p.Lvb,
                     "critical depth in among the valence bands, this is used "
                     "in warning output\n"
                     "as well as some generated files, such which "
                     "bandstructure data to include\n"
                     "in [eV]"),
              HELP__("Lcb", p.Lcb, "analog to Lvb for conduction bands"),
              HELP__("toldev", p.toldev,
                     "tolerable mismatch between folding and scaling "
                     "algorithms, affects warning\n"
                     "message only, in [meV]"),
              HELP__(
                  "Nthreads", p.Nthreads,
