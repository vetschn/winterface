    ...
    inline explicit printHelp_(const ll_tParser1 &p, std::ostream &os)
      ...
      printHelpTuple_(
          ...
          std::make_tuple(
              ...
              HELP__("tString1", p.tString1, "sample string"),
              HELP__("tStrings1", p.tStrings1, "sample array of strings"),
              HELP__("tDouble1", p.tDouble1, "sample double"),
              HELP__("tUint1", p.tUint1, "sample unsigned int"),
              HELP__("tBool1", p.tBool1, "should be discarded"),
              HELP__("tDoublesF1", p.tDoublesF1, "sample array of doubles"),
              HELP__("tDoublesV1", p.tDoublesV1, "sample array of doubles"),
              ...
              HELP__("tUintsVT1", p.tUintsVT1, NPOS__,
                     "sample array of unsigned ints"),
              HELP__("tBoolsF1", p.tBoolsF1, DIM__, "sample array of bools"),
              HELP__("tBoolsV1", p.tBoolsV1, "sample array of bools"),
              HELP__("tMat1", p.tMat1, "sample matrix"),
              HELP__("tMatF1", p.tMatF1, "sample matrix")));
    }
  };
};
