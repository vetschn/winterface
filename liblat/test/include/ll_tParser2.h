    ...
    inline explicit parseKey_(ll_tParser2& p, const uint32_t key,
      ...
      switch (key) {
        ...
        case "tBool2"_h:
          ...
          return;
        case "tDoublesF2"_h:
          PARSE__(p.tDoublesF2, DIM__);
          return;
        case "tDoublesV2"_h:
          PARSE__(p.tDoublesV2);
          return;
        case "tUintsFNT2"_h:
          PARSE__(p.tUintsFNT2, false, DIM__);
          return;
        case "tUintsFT2"_h:
          PARSE__(p.tUintsFT2, true, DIM__);
          return;
        case "tUintsVNT2"_h:
          PARSE__(p.tUintsVNT2, false, NPOS__);
          return;
        case "tUintsVT2"_h:
          PARSE__(p.tUintsVT2, true, NPOS__);
          return;
        case "tBoolsF2"_h:
          PARSE__(p.tBoolsF2, DIM__);
          return;
        case "tBoolsV2"_h:
          PARSE__(p.tBoolsV2);
          return;
    ...
    inline explicit printHelp_(const ll_tParser2& p, std::ostream& os)
      ...
      printHelpTuple_(
          ...
          std::make_tuple(
              ...
              HELP__("tString2", p.tString2, "sample string"),
              HELP__("tStrings2", p.tStrings2, "sample array of strings"),
              HELP__("tDouble2", p.tDouble2, "sample double"),
              HELP__("tUint2", p.tUint2, "sample unsigned int"),
              HELP__("tBool2", p.tBool2, "should be discarded"),
              HELP__("tDoublesF2", p.tDoublesF2, "sample array of doubles"),
              HELP__("tDoublesV2", p.tDoublesV2, "sample array of doubles"),
              ...
              HELP__("tUintsVT2", p.tUintsVT2, NPOS__,
                     "sample array of unsigned ints"),
              HELP__("tBoolsF2", p.tBoolsF2, DIM__, "sample array of bools"),
              HELP__("tBoolsV2", p.tBoolsV2, "sample array of bools"),
              HELP__("tMat2", p.tMat2, "sample matrix"),
              HELP__("tMatF2", p.tMatF2, "sample matrix")));
    }
  };
};
