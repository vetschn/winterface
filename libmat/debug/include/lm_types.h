...
template <class TT> class lm_c_tItr;
template <class TT> class lm_tItr;
template <ptrdiff_t> class lm_c_cpxItr;
template <ptrdiff_t> class lm_cpxItr;
...
template <class TT, class FT, class CT> class lm_tCol;
...
typedef std::reverse_iterator<c_fItr>
    cr_fItr; //!< reverse real custom increment const_iterator
typedef std::reverse_iterator<c_cItr>
    cr_cItr; //!< reverse complex custom increment const_iterator
typedef std::reverse_iterator<fItr>
    r_fItr; //!< reverse real custom increment iterator
typedef std::reverse_iterator<cItr>
    r_cItr;                     //!< reverse complex custom increment iterator
...
typedef lm_c_tVecItr<lm_tMat<RE__, RE__, CPX__>, lm_tRow<RE__, RE__, CPX__>>
    c_fRowItr;
//! complex row const_iterator
typedef lm_c_tVecItr<lm_tMat<CPX__, RE__, CPX__>, lm_tRow<CPX__, RE__, CPX__>>
    c_cRowItr;
//! real column const_iterator
typedef lm_c_tVecItr<lm_tMat<RE__, RE__, CPX__>, lm_tCol<RE__, RE__, CPX__>>
    c_fColItr;
//! complex column const_iterator
typedef lm_c_tVecItr<lm_tMat<CPX__, RE__, CPX__>, lm_tCol<CPX__, RE__, CPX__>>
    c_cColItr;
//! real row iterator
typedef lm_tVecItr<lm_tMat<RE__, RE__, CPX__>, lm_tRow<RE__, RE__, CPX__>>
    fRowItr;
//! complex row iterator
typedef lm_tVecItr<lm_tMat<CPX__, RE__, CPX__>, lm_tRow<CPX__, RE__, CPX__>>
    cRowItr;
//! real column iterator
typedef lm_tVecItr<lm_tMat<RE__, RE__, CPX__>, lm_tCol<RE__, RE__, CPX__>>
    fColItr;
//! complex column iterator
typedef lm_tVecItr<lm_tMat<CPX__, RE__, CPX__>, lm_tCol<CPX__, RE__, CPX__>>
    cColItr;
//! reverse real row const_iterator
typedef lm_cr_tVecItr<lm_tMat<RE__, RE__, CPX__>, lm_tRow<RE__, RE__, CPX__>>
    cr_fRowItr;
//! reverse complex row const_iterator
typedef lm_cr_tVecItr<lm_tMat<CPX__, RE__, CPX__>, lm_tRow<CPX__, RE__, CPX__>>
    cr_cRowItr;
//! reverse real column const_iterator
typedef lm_cr_tVecItr<lm_tMat<RE__, RE__, CPX__>, lm_tCol<RE__, RE__, CPX__>>
    cr_fColItr;
//! reverse complex column const_iterator
typedef lm_cr_tVecItr<lm_tMat<CPX__, RE__, CPX__>, lm_tCol<CPX__, RE__, CPX__>>
    cr_cColItr;
//! reverse real row iterator
typedef lm_r_tVecItr<lm_tMat<RE__, RE__, CPX__>, lm_tRow<RE__, RE__, CPX__>>
    r_fRowItr;
//! reverse complex row iterator
typedef lm_r_tVecItr<lm_tMat<CPX__, RE__, CPX__>, lm_tRow<CPX__, RE__, CPX__>>
    r_cRowItr;
//! reverse real column iterator
typedef lm_r_tVecItr<lm_tMat<RE__, RE__, CPX__>, lm_tCol<RE__, RE__, CPX__>>
    r_fColItr;
//! reverse complex column iterator
typedef lm_r_tVecItr<lm_tMat<CPX__, RE__, CPX__>, lm_tCol<CPX__, RE__, CPX__>>
    r_cColItr;
