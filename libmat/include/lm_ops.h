...
template <class T1> bool z_s(const T1 &inp) noexcept { return not_s(inp); }
//! strict comparison to not 0
template <class T1> bool nz_s(const T1 &inp) noexcept { return bool_s(inp); }
//! strict equality
...
template <class T1> bool bool_(const T1 &inp) noexcept { return nz(inp); }
//! tolerant logical NOT
template <class T1> bool not_(const T1 &inp) noexcept { return z(inp); }
 ...
 */
//! comparison to 0
template <class T1> bool z(const T1 &inp) noexcept { return z_s(inp); }
//! comparison to not 0
template <class T1> bool nz(const T1 &inp) noexcept { return nz_s(inp); }
//! equality
template <class T1, class T2> bool eq(const T1 &lhs, const T2 &rhs) noexcept {
  return eq_s(lhs, rhs);
}
 ...
 */
//! cast to bool
template <class T1> bool bool_(const T1 &inp) noexcept { return bool_s(inp); }
//! logical NOT
template <class T1> bool not_(const T1 &inp) noexcept { return not_s(inp); }
//! logical AND
template <class T1, class T2> bool and_(const T1 &lhs, const T2 &rhs) noexcept {
...
inline RE__ &modEq(RE__ &lhs, const RE__ rhs) {
  if (eq(lhs, RE__(0.0)), eq(rhs, RE__(0.0)))
    return lhs;
