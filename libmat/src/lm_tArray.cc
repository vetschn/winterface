...
template <class TT, class FT, class CT>
lm_tMat<FT, FT, CT>
lm_tArray<TT, FT, CT>::eq(const fArray &rhs) const noexcept {
  assert(M() == rhs.M());
  assert(N() == rhs.N());
  fMat res(M(), N());
  std::transform(
...
template <class TT, class FT, class CT>
lm_tMat<FT, FT, CT>
lm_tArray<TT, FT, CT>::eq(const cArray &rhs) const noexcept {
  assert(M() == rhs.M());
  assert(N() == rhs.N());
  fMat res(M(), N());
  std::transform(
...
template <class TT, class FT, class CT>
lm_tMat<FT, FT, CT>
lm_tArray<TT, FT, CT>::neq(const fArray &rhs) const noexcept {
  assert(M() == rhs.M());
  assert(N() == rhs.N());
  fMat res(M(), N());
  std::transform(
...
template <class TT, class FT, class CT>
lm_tMat<FT, FT, CT>
lm_tArray<TT, FT, CT>::neq(const cArray &rhs) const noexcept {
  assert(M() == rhs.M());
  assert(N() == rhs.N());
  fMat res(M(), N());
  std::transform(
...
template <class TT, class FT, class CT>
lm_tMat<FT, FT, CT>
lm_tArray<TT, FT, CT>::lt(const fArray &rhs) const noexcept {
  assert(M() == rhs.M());
  assert(N() == rhs.N());
  fMat res(M(), N());
  std::transform(
...
template <class TT, class FT, class CT>
lm_tMat<FT, FT, CT>
lm_tArray<TT, FT, CT>::lt(const cArray &rhs) const noexcept {
  assert(M() == rhs.M());
  assert(N() == rhs.N());
  fMat res(M(), N());
  std::transform(
...
template <class TT, class FT, class CT>
lm_tMat<FT, FT, CT>
lm_tArray<TT, FT, CT>::leq(const fArray &rhs) const noexcept {
  assert(M() == rhs.M());
  assert(N() == rhs.N());
  fMat res(M(), N());
  std::transform(
...
template <class TT, class FT, class CT>
lm_tMat<FT, FT, CT>
lm_tArray<TT, FT, CT>::leq(const cArray &rhs) const noexcept {
  assert(M() == rhs.M());
  assert(N() == rhs.N());
  fMat res(M(), N());
  std::transform(
...
template <class TT, class FT, class CT>
lm_tMat<FT, FT, CT>
lm_tArray<TT, FT, CT>::gt(const fArray &rhs) const noexcept {
  assert(M() == rhs.M());
  assert(N() == rhs.N());
  fMat res(M(), N());
  std::transform(
...
template <class TT, class FT, class CT>
lm_tMat<FT, FT, CT>
lm_tArray<TT, FT, CT>::gt(const cArray &rhs) const noexcept {
  assert(M() == rhs.M());
  assert(N() == rhs.N());
  fMat res(M(), N());
  std::transform(
...
template <class TT, class FT, class CT>
lm_tMat<FT, FT, CT>
lm_tArray<TT, FT, CT>::geq(const fArray &rhs) const noexcept {
  assert(M() == rhs.M());
  assert(N() == rhs.N());
  fMat res(M(), N());
  std::transform(
...
template <class TT, class FT, class CT>
lm_tMat<FT, FT, CT>
lm_tArray<TT, FT, CT>::geq(const cArray &rhs) const noexcept {
  assert(M() == rhs.M());
  assert(N() == rhs.N());
  fMat res(M(), N());
  std::transform(
