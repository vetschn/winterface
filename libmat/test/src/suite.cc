...
int main(int argc, char** argv) {
  ...
  runner.addTest(test_c_tVecItr_all<RE__, RE__, CPX__,
                                    lm_tRow<RE__, RE__, CPX__>>::suite());
  runner.addTest(test_c_tVecItr_all<CPX__, RE__, CPX__,
                                    lm_tRow<CPX__, RE__, CPX__>>::suite());
  runner.addTest(test_c_tVecItr_all<RE__, RE__, CPX__,
                                    lm_tCol<RE__, RE__, CPX__>>::suite());
  runner.addTest(test_c_tVecItr_all<CPX__, RE__, CPX__,
                                    lm_tCol<CPX__, RE__, CPX__>>::suite());
  runner.addTest(
      test_tVecItr_all<RE__, RE__, CPX__, lm_tRow<RE__, RE__, CPX__>>::suite());
  runner.addTest(test_tVecItr_all<CPX__, RE__, CPX__,
                                  lm_tRow<CPX__, RE__, CPX__>>::suite());
  runner.addTest(
      test_tVecItr_all<RE__, RE__, CPX__, lm_tCol<RE__, RE__, CPX__>>::suite());
  runner.addTest(test_tVecItr_all<CPX__, RE__, CPX__,
                                  lm_tCol<CPX__, RE__, CPX__>>::suite());
  runner.addTest(test_cr_tVecItr_all<RE__, RE__, CPX__,
                                     lm_tRow<RE__, RE__, CPX__>>::suite());
  runner.addTest(test_cr_tVecItr_all<CPX__, RE__, CPX__,
                                     lm_tRow<CPX__, RE__, CPX__>>::suite());
  runner.addTest(test_cr_tVecItr_all<RE__, RE__, CPX__,
                                     lm_tCol<RE__, RE__, CPX__>>::suite());
  runner.addTest(test_cr_tVecItr_all<CPX__, RE__, CPX__,
                                     lm_tCol<CPX__, RE__, CPX__>>::suite());
  runner.addTest(test_r_tVecItr_all<RE__, RE__, CPX__,
                                    lm_tRow<RE__, RE__, CPX__>>::suite());
  runner.addTest(test_r_tVecItr_all<CPX__, RE__, CPX__,
                                    lm_tRow<CPX__, RE__, CPX__>>::suite());
  runner.addTest(test_r_tVecItr_all<RE__, RE__, CPX__,
                                    lm_tCol<RE__, RE__, CPX__>>::suite());
  runner.addTest(test_r_tVecItr_all<CPX__, RE__, CPX__,
