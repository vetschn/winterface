...
template <> void test_tRow_all<CPX__, RE__, CPX__>::test_assign() {
...
template <> void test_tRow_all<CPX__, RE__, CPX__>::test_matrix_arithmetic() {
...
// test id
template <> const char *test_tRow_all<CPX__, RE__, CPX__>::test_id() noexcept {
