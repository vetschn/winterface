...
template <>
void test_cr_tVecItr_all<CPX__, RE__, CPX__,
...
// test id
template <>
const char* test_cr_tVecItr_all<
    CPX__, RE__, CPX__, lm_tCol<CPX__, RE__, CPX__>>::test_id() noexcept {
  return "test_cr_cColItr_all";
}

// instantiation
template class test_cr_tVecItr_all<CPX__, RE__, CPX__,
