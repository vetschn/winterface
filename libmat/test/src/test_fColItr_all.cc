...
template <>
void test_tVecItr_all<RE__, RE__, CPX__,
...
// test id
template <>
const char *test_tVecItr_all<RE__, RE__, CPX__,
                             lm_tCol<RE__, RE__, CPX__>>::test_id() noexcept {
  return "test_fColItr_all";
}

// instantiation
template class test_tVecItr_all<RE__, RE__, CPX__, lm_tCol<RE__, RE__, CPX__>>;
