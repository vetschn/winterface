...
CppUnit::Test* test_r_tVecItr_all<TT, FT, CT, VT>::suite() {
  ...
  suite->addTest(new CppUnit::TestCaller<test_r_tVecItr_all>(
      "test_ctor_assign",
      &test_r_tVecItr_all<TT, FT, CT, VT>::test_ctor_assign));
  suite->addTest(new CppUnit::TestCaller<test_r_tVecItr_all>(
  ...
  suite->addTest(new CppUnit::TestCaller<test_r_tVecItr_all>(
      "test_dereference",
      &test_r_tVecItr_all<TT, FT, CT, VT>::test_dereference));
  suite->addTest(new CppUnit::TestCaller<test_r_tVecItr_all>(
      "test_arithmetic_difference",
      &test_r_tVecItr_all<TT, FT, CT, VT>::test_arithmetic_difference));
