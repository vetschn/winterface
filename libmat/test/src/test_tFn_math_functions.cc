...
CppUnit::Test *test_tFn_math_functions<TT, FT, CT>::suite() {
  ...
  suite->addTest(new CppUnit::TestCaller<test_tFn_math_functions>(
      "test_ceilEq_ceil",
      &test_tFn_math_functions<TT, FT, CT>::test_ceilEq_ceil));
  suite->addTest(new CppUnit::TestCaller<test_tFn_math_functions>(
      "test_floorEq_floor",
      &test_tFn_math_functions<TT, FT, CT>::test_floorEq_floor));
  suite->addTest(new CppUnit::TestCaller<test_tFn_math_functions>(
      "test_roundEq_round",
      &test_tFn_math_functions<TT, FT, CT>::test_roundEq_round));
  suite->addTest(new CppUnit::TestCaller<test_tFn_math_functions>(
      "test_signEq_sign",
      &test_tFn_math_functions<TT, FT, CT>::test_signEq_sign));
