...
CppUnit::Test* test_tMat_assign<TT, FT, CT>::suite() {
  ...
  suite->addTest(new CppUnit::TestCaller<test_tMat_assign>(
      "test_operator_equal_fArray",
      &test_tMat_assign<TT, FT, CT>::test_operator_equal_fArray));
  suite->addTest(new CppUnit::TestCaller<test_tMat_assign>(
      "test_operator_equal_cArray",
      &test_tMat_assign<TT, FT, CT>::test_operator_equal_cArray));
  suite->addTest(new CppUnit::TestCaller<test_tMat_assign>(
      "test_operator_equal_cpy",
      &test_tMat_assign<TT, FT, CT>::test_operator_equal_cpy));
  suite->addTest(new CppUnit::TestCaller<test_tMat_assign>(
      "test_operator_equal_move",
      &test_tMat_assign<TT, FT, CT>::test_operator_equal_move));
