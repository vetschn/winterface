...
CppUnit::Test* test_tMat_basic_modification<TT, FT, CT>::suite() {
  ...
  suite->addTest(new CppUnit::TestCaller<test_tMat_basic_modification>(
      "test_clear_resize",
      &test_tMat_basic_modification<TT, FT, CT>::test_clear_resize));
  suite->addTest(new CppUnit::TestCaller<test_tMat_basic_modification>(
      "test_push_back_shift",
      &test_tMat_basic_modification<TT, FT, CT>::test_push_back_shift));
  suite->addTest(new CppUnit::TestCaller<test_tMat_basic_modification>(
      "test_pop_back",
      &test_tMat_basic_modification<TT, FT, CT>::test_pop_back));
