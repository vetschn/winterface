...
template <class TT, class FT, class CT>
void test_tMat_basic_properties_info<
    TT, FT, CT>::test_M_N_L_size_lcap_ccap_empty_incr() {
  const size_t M = genRndST();
  const size_t N = genRndST();
...
CppUnit::Test *test_tMat_basic_properties_info<TT, FT, CT>::suite() {
  ...
  suite->addTest(new CppUnit::TestCaller<test_tMat_basic_properties_info>(
      "test_row_col_cpx",
      &test_tMat_basic_properties_info<TT, FT, CT>::test_row_col_cpx));
  suite->addTest(new CppUnit::TestCaller<test_tMat_basic_properties_info>(
      "test_M_N_L_size_lcap_ccap_empty_incr",
      &test_tMat_basic_properties_info<
          TT, FT, CT>::test_M_N_L_size_lcap_ccap_empty_incr));
  suite->addTest(new CppUnit::TestCaller<test_tMat_basic_properties_info>(
      "test_square_hermitian_diag",
      &test_tMat_basic_properties_info<TT, FT,
                                       CT>::test_square_hermitian_diag));
  suite->addTest(new CppUnit::TestCaller<test_tMat_basic_properties_info>(
      "test_ob_onb",
      &test_tMat_basic_properties_info<TT, FT, CT>::test_ob_onb));
