  ...
  struct printHelp_ : public virtual aux_parser::printHelp_ {
    ...
    inline explicit printHelp_(const c_input &p, std::ostream &os)
      ...
      printHelpTuple_(
          os, std::make_tuple(
                  TOPIC__("-f: FILENAMES"),
                  HELP__("bh", p.bh, "filename for the input bh"),
                  HELP__("psc", p.psc, "filename for the cell.psc file"),
                  HELP__("wbh", p.wbh, "filename for the output wbh"),
                  HELP__("outcar", p.outcar,
                         "VASP OUTCAR file to determine Fermi energy")

                      ,
                  TOPIC__("-f: PARAMETERS"),
                  HELP__("Ef", p.Ef, "override for the Fermi energy")));
    }
  };
};
